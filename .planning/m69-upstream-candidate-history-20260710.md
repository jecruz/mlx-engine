# M69 Upstream Candidate History
...
| --- | --- | --- | --- | ---: |
| 2026-07-09T04:05:00Z (edf0c23) | `edf0c23` | `` | `` | 6 |
| e5e4b5b | `e5e4b5b` | `8ae2610` | `8f0fa26` | 6 |
| a5f2f74 | `a5f2f74` | `8ae2610` | `8f0fa26` | 6 |
| a1a9dea | `a1a9dea` | `8ae2610` | `8f0fa26` | 6 |
| 42e272b | `42e272b` | `8ae2610` | `8f0fa26` | 6 |
| b8ea9c3 | `b8ea9c3` | `8ae2610` | `8f0fa26` | 6 |

## Scan-by-Scan Changes

### Scan `2026-07-09T04:05:00Z (edf0c23)`
...
- Baseline scan in this history sequence.

### Scan `e5e4b5b`

- Repository: `/Users/jeffreycruz/Development/LLM_INFERENCE/mlx-engine`
- Head: `e5e4b5b`
- Upstream/main: `8ae2610`
- Origin branch: `8f0fa26`
- Candidate branches: `6`

- Baseline scan: `2026-07-09T04:05:00Z (edf0c23)`
- Branch deltas: changed `0`, new `0`, removed `0`, unchanged `6`

| Branch | Previous head | Current head | Status | Surface | Previous files | Current files | Previous unmatched | Current unmatched |
| --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `upstream/neil/gemma4-tool-context` | `9aa3db2` | `9aa3db2` | unchanged | broad | 0 | 7 | 0 | 18 |
| `upstream/neil/img-caching` | `7dfe3cd` | `7dfe3cd` | unchanged | broad | 0 | 94 | 0 | 13 |
| `upstream/neil/vlm-parity-ci` | `ea1a6bb` | `ea1a6bb` | unchanged | broad | 0 | 44 | 0 | 82 |
| `upstream/will/lfm-2.5-unified` | `461015c` | `461015c` | unchanged | broad | 0 | 83 | 0 | 1 |
| `upstream/yagil/dist` | `366ebd4` | `366ebd4` | unchanged | broad | 0 | 84 | 0 | 0 |
| `upstream/yagil/mlx-dist-non-batched` | `c86c23a` | `c86c23a` | unchanged | broad | 0 | 84 | 0 | 6 |
